var __wpo = {
	"assets": {
		"main": ["./output.js", "./css/main.min.css"],
		"additional": [],
		"optional": []
	},
	"externals": [],
	"hashesMap": {
		"c13e46166313f13225327cab8cf09bf828947ded": "./output.js",
		"b2a6cf21f83a9703a98188ee94855759e13fe963": "./css/main.min.css"
	},
	"strategy": "changed",
	"responseStrategy": "cache-first",
	"version": "2018-9-14 11:10:04",
...
! function(e) {
	...
	function u(e, n) {
		return caches.match(e, {
			...
			return c(t) ? t : s(t).then(function(t) {
	...
	function s(e) {
		return c(e) ? Promise.resolve(e) : ("body" in e ? Promise.resolve(e.body) : e.blob()).then(function(n) {
	...
	function f(e, n) {
		...
		}), c = Object.keys(c).reduce(function(e, n) {
			var t = new URL(c[n], location);
		...
		function P(n) {
			return caches.keys().then(function(e) {
				...
				var r = t[0],
					...
					u = o.hashmap,
					s = o.version;
				if(!o.hashmap || s === e.version) return w(n);
		...
		self.addEventListener("install", function(e) {
			...
			n = (n = (n = n.then(O)).then(b)).then(function() {
			...
			if("GET" === e.request.method && ("only-if-cached" !== e.request.cache || "same-origin" === e.request.mode)) {
				...
				if(a) {
					...
					}(e, i, c), e.respondWith(f)
				} else {
					if("navigate" === e.request.mode && !0 === r) return void e.respondWith(U(e));
					if(r) {
						var h = function(e) {
							var n = new URL(e.request.url);
							if(self.registration.navigationPreload && r && r.test && r.test(n, e.request)) {
								var t = function(e) {
										if(x) {
											var n = void 0,
												t = void 0;
											return x.forEach(function(r, i) {
												r.url.href === e.href && (n = r.response, t = i)
											}), n ? (x.delete(t), n) : void 0
										}
									}(n),
									i = e.request;
		...
		function q(e, n, t) {
			...
			return o && (u = Promise.all(n.map(function(n) {
				...
				var n, t, i;
				return r && (t = r, i = -1 !== (n = e).indexOf("?"), e = n + (i ? "&" : "?") + "__uncache=" + encodeURIComponent(t)), fetch(e, a).then(s).then(function(e) {
					return e.ok ? {
						response: e
					} : {
						error: !0
